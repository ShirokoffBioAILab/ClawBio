...
SKILLS = {
    ...
    "healthomics": {
        "script": SKILLS_DIR / "healthomics-bridge" / "healthomics_bridge.py",
        "demo_args": ["--demo"],
        ...
        "allowed_extra_flags": {
            ...
            "--allow-remote-inputs", "--confirm-submit",
            "--run-status", "--start-run", "--resume-from", "--upload-inputs", "--download-outputs",
            "--register", "--describe-run-group", "--describe-run-cache",
            "--list-workflow-versions", "--search-workflows", "--recommend-workflow",
            "--params-template", "--tag-run", "--untag-run", "--list-tags",
            "--sync-tags", "--workflow-type", "--params", "--output-uri",
            "--role-arn", "--run-name", "--to", "--workflow-name", "--engine",
            "--additional-files", "--description", "--parameter-template",
            "--workflow-id", "--new-version-name", "--tags", "--tag-keys",
            "--storage-type", "--storage-capacity", "--cache-id",
            "--cache-behavior", "--run-group-id", "--workflow-version-name",
